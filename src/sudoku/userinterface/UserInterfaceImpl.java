...
public class UserInterfaceImpl implements IUserInterfaceContract.View,
    ...
    private void drawSudokuBoard(Group root) {
        Rectangle boardBackround = new Rectangle();
        boardBackround.setX(BOARD_PADDING);
        boardBackround.setY(BOARD_PADDING);

        boardBackround.setWidth(BOARD_X_AND_Y);
        boardBackround.setHeight(BOARD_X_AND_Y);

        boardBackround.setFill(BOARD_BACKROUND_COLOR);

        root.getChildren().addAll(boardBackround);
    }
    ...
    private void drawBackround(Group root) {
